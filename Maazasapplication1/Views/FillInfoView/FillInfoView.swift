...
struct FillInfoView: View {
    @StateObject var fillInfoViewModel = FillInfoViewModel()
    ...
    var body: some View {
        ZStack(alignment: .bottom) {
            ...
            .frame(width: UIScreen.main.bounds.width, height: UIScreen.main.bounds.height)
            if fillInfoViewModel.isSuccessViewShow {
                BottomSheetView(isOpen: $fillInfoViewModel.isSuccessViewShow, content: {
                    SuccessView(successViewModel: SuccessViewModel(_isOpen: $fillInfoViewModel
                            .isSuccessViewShow))
